...
export class TransactionsController {
  ...
  @ApiOperation({
    ...
    description: 'Soporta filtros por tipo, categoría, rango de fechas y paginación.',
  })
  ...
  findOne(@Param('id', new ParseUUIDPipe()) id: string): Promise<TransactionResponseDto> {
  ...
  create(@Body() createTransactions: CreateTransactionsDto): Promise<TransactionResponseDto[]> {
    const { items } = createTransactions;
    return this.createTransactionUseCase.execute(items);
  }
