...
//   }
  ...
  @ApiOperation({
    ...
    description: "Returns today's cycle (startDate, endDate, label). No transaction data.",
  })
  @ApiResponse({
    status: 200,
    schema: {
  ...
  @ApiOperation({
    ...
    description: 'Pass any YYYY-MM-DD date and get back the cycle that contains it.',
  })
  @ApiQuery({ name: 'date', required: true, example: '2024-03-10' })
  @ApiResponse({
    status: 200,
    schema: {
      example: { label: 'Marzo 2024', startDate: '2024-02-27', endDate: '2024-03-26' },
    },
  })
  ...
  @ApiResponse({
    status: 200,
    description: 'Cycle summary with income, expense, balance, and category breakdown',
    schema: {
      example: {
        cycle: { label: 'Marzo 2024', startDate: '2024-02-27', endDate: '2024-03-26' },
        income: 5000000,
        expense: 2300000,
        balance: 2700000,
        transactionCount: 8,
        categoryBreakdown: [
          { categoryId: '1', categoryName: 'Hogar', categoryEmoji: '🏠', total: 1500000 },
        ],
      },
    },
  })
